...
const terminals = [
  ...
  { name: "Major League Baseball", terminal: "MLB Pulse Market Terminal Ticker", status: "demo", tam: "$12.6B", emoji: "⚾", color: "from-red-600 to-red-800" },
  { name: "National Football League", terminal: "NFL Pulse Market Terminal Ticker", status: "demo", tam: "$18.3B", emoji: "🏈", color: "from-green-600 to-green-800" },
  { name: "National Basketball Association", terminal: "NBA Pulse Market Terminal Ticker", status: "demo", tam: "$14.7B", emoji: "🏀", color: "from-orange-500 to-red-600" },
  { name: "National Hockey League", terminal: "NHL Pulse Market Terminal Ticker", status: "demo", tam: "$4.2B", emoji: "🏒", color: "from-blue-600 to-blue-800" },
  { name: "DragonBall Z", terminal: "DBZ Pulse Market Terminal Ticker", status: "demo", tam: "$6.8B", emoji: "🐉", color: "from-orange-400 to-yellow-500" },
  { name: "Star Wars", terminal: "Star Wars Pulse Market Terminal Ticker", status: "demo", tam: "$9.5B", emoji: "⭐", color: "from-gray-600 to-gray-900" },
  { name: "FIFA Soccer", terminal: "FIFA Pulse Market Terminal Ticker", status: "demo", tam: "$7.3B", emoji: "⚽", color: "from-emerald-500 to-teal-600" },
];
      ...
      <section className="py-16 px-4 bg-muted/30 border-t border-border/40">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-muted-foreground text-sm">
            ...
            fund simultaneous development of the first 5 Pulse Market Terminal Tickers.
          </p>
