...
export const franchiseConfigs: Record<string, FranchiseConfig> = {
  mlb: {
    id: "mlb", name: "MLB Pulse Engine", tagline: "Professional-grade market intelligence for baseball card collectors and investors. Track Topps, Bowman, and vintage to modern rookie cards.",
  ...
  nfl: {
    id: "nfl", name: "NFL Pulse Engine", tagline: "Real-time football card market data for Panini Prizm, Contenders, and vintage gridiron assets.",
  ...
  nba: {
    id: "nba", name: "NBA Pulse Engine", tagline: "Track basketball card markets from vintage Fleer to modern Panini Prizm with institutional-grade analytics.",
  ...
  nhl: {
    id: "nhl", name: "NHL Pulse Engine", tagline: "Hockey card market intelligence — Young Guns, O-Pee-Chee, and vintage puck assets tracked in real time.",
  ...
  fifa: {
    id: "fifa", name: "FIFA Soccer Pulse Engine", tagline: "Global football (soccer) card market — World Cup Prizm, Topps Chrome UCL, and sticker markets worldwide.",
  ...
  mtg: {
    id: "mtg", name: "Magic: The Gathering Pulse Engine", tagline: "Track Power Nine, Reserved List, and modern staples across all MTG formats with precision analytics.",
  ...
  yugioh: {
    id: "yugioh", name: "Yu-Gi-Oh! Pulse Engine", tagline: "Monitor LOB 1st Edition, Ghost Rares, and tournament staples across the Yu-Gi-Oh! TCG ecosystem.",
  ...
  dbz: {
    id: "dbz", name: "Dragon Ball Z Pulse Engine", tagline: "Track Saiyan Saga to Tournament of Power — Dragon Ball Super and vintage DBZ card markets in one terminal.",
  ...
  lorcana: {
    id: "lorcana", name: "Lorcana Pulse Engine", tagline: "Disney Lorcana TCG market intelligence — Enchanted rares, sealed product, and meta staples tracked live.",
  ...
  starwars: {
    id: "starwars", name: "Star Wars Pulse Engine", tagline: "Vintage 1977 Topps to modern Chrome — the definitive Star Wars card market data terminal.",
