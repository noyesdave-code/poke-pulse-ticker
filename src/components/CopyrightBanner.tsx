...
const CopyrightBanner = () => {
  return (
    <div data-demo-hide className="fixed bottom-0 left-0 right-0 z-50 bg-card/98 backdrop-blur-sm border-t border-border/[0.03]">
      <div className="max-w-7xl mx-auto px-2 py-0.5 flex items-center justify-center gap-1">
