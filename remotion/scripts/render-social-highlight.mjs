...
await renderMedia({
  ...
  serveUrl: bundled,
  codec: "h264",
  outputLocation: "/mnt/documents/social-highlight-vertical.mp4",
  puppeteerInstance: browser,
  muted: true,
  concurrency: 1,
});
console.log("✅ Vertical social highlight rendered.");
...
await renderMedia({
  ...
  serveUrl: bundled,
  codec: "h264",
  outputLocation: "/mnt/documents/social-highlight-youtube.mp4",
  puppeteerInstance: browser,
  muted: true,
  concurrency: 1,
});
console.log("✅ YouTube social highlight rendered.");
